...
--  Diagrama: software1
--  Autor: Angelina
--  Fecha y hora: 05/04/2023 20:13:33
...
CREATE TABLE [prueba_rendimiento] (
	...
	[comentario_prueba] VARCHAR(150) NOT NULL,
...
CREATE TABLE [clasificacion] (
	[idclasificacion] INT IDENTITY NOT NULL,
	[desc_clasificacion] VARCHAR(50) NOT NULL,
	[status_idstatus] INT NOT NULL,
...
ALTER TABLE [prueba_rendimiento] ADD CONSTRAINT [prueba_rendimiento_materia_prima_materia_prima_idmateria_prima] FOREIGN KEY ([materia_prima_idmateria_prima]) REFERENCES [materia_prima]([idmateria_prima]) ON DELETE NO ACTION ON UPDATE CASCADE;
...
ALTER TABLE [materia_prima] ADD CONSTRAINT [materia_prima_clasificacion_clasificacion_idclasificacion] FOREIGN KEY ([clasificacion_idclasificacion]) REFERENCES [clasificacion]([idclasificacion]) ON DELETE NO ACTION ON UPDATE CASCADE;
...
ALTER TABLE [clasificacion] ADD CONSTRAINT [clasificacion_status_status_idstatus] FOREIGN KEY ([status_idstatus]) REFERENCES [status]([idstatus]) ON DELETE NO ACTION ON UPDATE CASCADE;
...
ALTER TABLE [detalle_prueba_rendimiento] ADD CONSTRAINT [detalle_prueba_rendimiento_status_status_idstatus] FOREIGN KEY ([status_idstatus]) REFERENCES [status]([idstatus]) ON DELETE NO ACTION ON UPDATE CASCADE;
